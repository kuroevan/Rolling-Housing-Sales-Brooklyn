...
library(plyr)
library(gdata)
#setwd('C:\\Users\\Evan\\Desktop\\SMU\\Data Science\\week5')
setwd('C:\\Users\\Evan\\Desktop\\SMU\\Data Science\\week5\\Rolling Housing Sales Brooklyn\\data')
## You need a perl interpreter to do this on Windows.
#perl <- 'C:\\Program Files\\MATLAB\\MATLAB Production Server\\R2015a\\sys\\perl\\win32\\bin\\perl5.8.9.exe'
